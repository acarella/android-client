...
public class AgentActivity extends ActionBarActivity implements AgentDetailsFragment.OnFragmentInteractionListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AgentDetailsFragment agentDetailsFragment = AgentDetailsFragment.newInstance(clientId, workaround);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
                ...
                API.gpsCoordinatesService.setGpsCoordinates(clientId,
                        ...
                        new Callback<GpsCoordinatesResponse>(){
                            ...
                            public void success(GpsCoordinatesResponse gpsCoordinatesResponse, Response response) {
                                Log.d("online/AgentActivity", "Successfully saved GPS coordinates");
                            }

                            @Override
                            public void failure(RetrofitError retrofitError) {
                                Log.d("online/AgentActivity", "Failed to save GPS coordinates");
                            }
                        });
                ;
            } else {
        ...
        if (id == MENU_ITEM_NEW_CLIENT){
            Intent intent = new Intent(AgentActivity.this, NewClientCreationLoginActivity.class);
            startActivity(intent);
        }

        if (id == MENU_ITEM_LOGOUT){
            Intent intent = new Intent(AgentActivity.this, LogoutActivity.class);
            startActivity(intent);
        }
