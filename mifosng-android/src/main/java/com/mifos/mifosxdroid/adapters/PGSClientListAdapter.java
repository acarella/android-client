...
/**
 * Created by antoniocarella on 6/8/14.
 * Uses code from ClientListAdapter
 */
public class PGSClientListAdapter extends BaseAdapter {
    ...
    public PGSClientListAdapter(Context context, List<Client> listClient) {
